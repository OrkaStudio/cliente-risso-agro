...
/**
 * El alquiler de un campo, como serie de cuotas pendientes de un año a
 * partir del primer pago: lo pactado entra como costo recurrente del campo
 * en Analítica y la Agenda. Categoría global "Alquiler de campo".
 */
